        ...
        protected override JsonProperty CreateProperty(MemberInfo member, MemberSerialization memberSerialization)
        {
            ...
            if (property.DeclaringType == typeof(Document))
            {
                if (property.PropertyType == typeof(Actions))
                    ...
                    property.ShouldSerialize = instance =>
                        (instance as Document).Properties != null &&
                        (instance as Document).Properties.GetType().GetProperties().Any();
            }
            else if (property.DeclaringType == typeof(Entity))
            {
                if (property.PropertyType == typeof(Actions))
                    ...
                    property.ShouldSerialize = instance =>
                        (instance as Entity).Properties != null &&
                        (instance as Entity).Properties.GetType().GetProperties().Any();
            }
