...
using GlobalX.AspNetCore.Hateoas.Siren.Core.Builders;

namespace GlobalX.AspNetCore.Hateoas.Siren.Core
{
    public static class Extensions
    {
        public static Actions Add(this Actions self, string name, string title, string method, Href href,
            string type = "application/x-www-form-urlencoded", IEnumerable<Field> fields = null)
        {
            var item = new Action
            {
                Name = name,
