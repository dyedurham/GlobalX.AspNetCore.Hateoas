...
namespace GlobalX.AspNetCore.Hateoas.Siren.Core
{
    public class Link
    {
        ...
        public static readonly Func<Href, Link> PredecessorVersion =
            href => new Link {Rel = Rel.PredecessorVersion, Href = href};
        ...
        public static readonly Func<Href, Link> SuccessorVersion =
            href => new Link {Rel = Rel.SuccessorVersion, Href = href};

        public static readonly Func<Href, Link> Tag = href => new Link {Rel = Rel.Tag, Href = href};

        public static readonly Func<Href, Link> TermsOfService =
            href => new Link {Rel = Rel.TermsOfService, Href = href};
        ...
        public static readonly Func<Href, Link> VersionHistory =
            href => new Link {Rel = Rel.VersionHistory, Href = href};
