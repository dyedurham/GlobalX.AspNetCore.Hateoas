...
using GlobalX.AspNetCore.Hateoas.JsonApi.Core;
using Newtonsoft.Json;

namespace GlobalX.AspNetCore.Hateoas.JsonApi.Converters
{
    internal class LinksConverter : JsonConverter
    {
        ...
        private void WriteJson(JsonWriter writer, IEnumerable<Link> value, JsonSerializer serializer)
        {
            ...
            var links = value.ToDictionary(x => x.Rel,
                x => x.Meta == null ? (object) x.Href : (object) new {x.Href, x.Meta});
