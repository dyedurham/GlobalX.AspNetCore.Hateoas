namespace GlobalX.AspNetCore.Hateoas.JsonApi.Core
{
    ...
    public partial class Link
    {
        ...
        public static readonly CreateDelegate PredecessorVersion =
            (href, meta) => new Link(Rel.PredecessorVersion, href, meta);
        ...
        public static readonly CreateDelegate SuccessorVersion =
            (href, meta) => new Link(Rel.SuccessorVersion, href, meta);
