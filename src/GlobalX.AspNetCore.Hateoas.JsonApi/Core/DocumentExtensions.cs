...
namespace GlobalX.AspNetCore.Hateoas.JsonApi.Core
{
    ...
    {
        public static void Links(this Document document, Func<Document, Func<Rel>> rel, string href,
            dynamic meta = null)
        {
            document.Links.Add(rel(document)(), href, meta);
        }

        public static void Links(this Document document, Func<Document, Func<Rel>> rel, string format,
            params object[] args)
        {
